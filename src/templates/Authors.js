...
export default function Authors({ data: { author } }) {
  return (
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              All threads posted by {author.name}
            </p>
          </div>
          <p
          ...
          >
            Since they joined, {author.name} has posted 12 posts and 24
            comments.
          </p>
        </div>
        <div
...
export const query = graphql`
  query ($slug: String!) {
    author: sanityAuthor(slug: { current: { eq: $slug } }) {
      ...
      datejoined(formatString: "DD/MM/YY")
    }
  }
`
