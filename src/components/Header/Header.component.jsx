...
export default function Header() {
  return (
    <div
      className="header-component flex space-x-80 items-center justify-end py-4 bg-white shadow rounded font-body"
      style={{ margin: "0 10rem" }}
    >
      <Link to="/" className="header-component-logo">
        <img className="w-40 h-full" src={logo} />
      </Link>

      <div className="header-component-search flex items-center justify-start py-2.5 pl-5 pr-72 bg-gray-200 rounded-full">
      ...
      <div className="header-component-btn w-36 h-11">
        <Link
          to="/signup"
