...
const SignIn = () => {
  return (
    <div
      className="signin-container relative bg-gray-50"
      style={{ width: 2000, height: 1470 }}
    >
      <div
        className="left-container inline-flex flex-col space-y-52 items-center justify-end px-6 pt-96 absolute left-0 top-0 bg-indigo-700"
      ...
      <div
        className="login-container inline-flex flex-col space-y-2 items-end justify-end pb-5 absolute"
        style={{ width: 906, height: 624, left: 843, top: 423 }}
      >
        <div
          className="signin-inner flex flex-col space-y-8 items-center justify-end"
          style={{ width: 675, height: 164, margin: "13rem 14rem" }}
        >
          <p className="signin-inner-text w-48 h-1/3 text-5xl font-bold text-gray-800 font-headline">
            Login
          </p>
          <p
            className="signin-para text-2xl leading-10 text-gray-600 font-body"
            style={{ width: 675 }}
          >
        ...
        <div
          className="signin-form inline-flex items-center justify-end"
          style={{ width: 906, height: 390 }}
        >
          <div className="signin-form-inner inline-flex flex-col space-y-10 items-center justify-end w-96">
            <div className="flex flex-col space-y-11 items-center justify-end w-full h-72">
              <div className="signin-form-column flex flex-col space-y-4 items-center justify-end w-full h-28">
            ...
            <div className="signin-btn w-full h-1/5">
              <div className="signin-btn-inner flex items-center justify-center flex-1 h-full px-28 py-6 bg-indigo-700 shadow rounded">
                <a
        ...
        <p
          className="signin-signup text-2xl leading-9 font-body"
