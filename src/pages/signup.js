    ...
    <div className="relative bg-gray-50">
      ...
      >
        <div className="w-64 h-full">
          <a className="flex items-center justify-center flex-1 h-full px-10 py-6 bg-indigo-700 shadow rounded text-2xl font-semibold text-center text-white cursor-pointer font-body">
            Create Account
          </a>
        </div>
        <p className="w-96 text-2xl leading-9 font-body">
          Already have an account?
          <a className="text-indigo-700 font-body" href="/signin">
            &nbsp;Sign in
          </a>
          .
        </p>
